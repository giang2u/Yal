...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Feb 22 18:03:23 CET 2018
  */
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$AnalyseurSyntaxique$act_num)
		...
		ArbreAbstrait lis = (ArbreAbstrait)((java_cup.runtime.Symbol) CUP$AnalyseurSyntaxique$stack.elementAt(CUP$AnalyseurSyntaxique$top-1)).value;
  		...
  		/*	for(ArbreAbstrait a:((BlocDInstructions)lis).getexpr()) {
			//	System.out.println(a);
				bloc.ajouter(a);
			}

			for(ArbreAbstrait a:((BlocDInstructions)bloc).getexpr()) {
			//	System.out.println("bloc "+a);
			}
			*/
			/*for(ArbreAbstrait a:arbreBoucle.getexpr()
			) {
				System.out.println("ab " +a);
			}*/
			//((BlocDInstructions)lis).getexpr().clear();
